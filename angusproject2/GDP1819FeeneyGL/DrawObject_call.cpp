...
//			glPolygonMode( GL_FRONT_AND_BACK , GL_LINE );	//GL_FILL
	...
	if (pCurrentMesh->friendlyName == "PlayerShip")
	{
		...
		glm::vec4 noseContactPoint_ModelSpace = glm::vec4(0.0f, 0.0f, 20.0f, 1.0f);
		// The wings are on the XZ plane, about -0.3 back from the centre
		glm::vec4 body1ContactPoint_ModelSpace = glm::vec4(0.0f, 0.0f, 10.0f, 1.0f);
		glm::vec4 tailTipContactPoint_ModelSpace = glm::vec4(0.0f, 0.0f, 0.5f, 1.0f);
		glm::vec4 thrust1ContactPoint_ModelSpace = glm::vec4(0.0f, 0.0f, -17.0f, 1.0f);
		glm::vec4 thrust2ContactPoint_ModelSpace = glm::vec4(0.0f, 0.0f, -10.0f, 1.0f);
		glm::vec4 thrust3ContactPoint_ModelSpace = glm::vec4(-2.2f, 0.0f, -8.5f, 1.0f);
